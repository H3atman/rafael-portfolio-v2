...
date: "2025-08-10"
tags: ["FastAPI", "Polars", "Docker", "Data Processing", "Government"]
thumbnail: "/projects/crimestat_api_thumbnail.png"
---

## Project Overview

As a Crime Statistician for a regional government agency, I was responsible for processing and categorizing crime statistics data in regional level. What started as a personal Python script to automate tedious Excel work evolved into a full-stack application now deployed on a VPS and serving daily operations.
